...
throw e.stack&&console&&console.error&&console.error("[TryCatch]"+e.stack),c&&window.__moon_report&&(window.__moon_report([{
offset:m,
log:"timeout_error",
e:e
}]),r(f)),e;
...
if(/mp\.weixin\.qq\.com\/s\?/.test(location.href)&&!(Math.random()>.5)){
var c,s,u,f,l=window.define,p=0,m=9;
window.__initCatch=function(e){
c=e.idkey,s=e.startKey||0,u=e.limit||1,_reportOpt=e.reportOpt||"",_extInfo=e.extinfo||"";
},window.__moon_report=function(o){
if(t(o)&&(o=[o]),e(o)&&""!=c){
for(var r="",a=[],f=[],l=[],p=[],m=0;m<o.length;m++){
var w=o[m]||{};
w.offset>u||"number"==typeof w.offset&&(a[m]=w.log+";"+n(w.e||{})||"",f[m]=s+w.offset,
l[m]=1);
}
for(var d=0;d<f.length;d++)p[d]=c+"_"+f[d]+"_"+l[d],r=r+"&log"+d+"="+a[d];
p.length>0&&i("idkey="+p.join(";")+"&lc="+a.length+r);
}
},window.setTimeout=a(window.setTimeout),window.setInterval=a(window.setInterval),
window.seajs&&l&&(window.define=function(){
