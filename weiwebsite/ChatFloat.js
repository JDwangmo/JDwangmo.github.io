var SocketIp = "http://v3002.bjsxp02.host.35.com/tpl/Wap/default/common/js/kf.weimob.com";
var TimeInterval;
var getType = 1;
var ajaxAddress = "WeimobLogin.aspx-ReturnUrl=-.htm"/*tpa=http://kf.weimob.com/*/;
...
window.ChatFloat = function (options) {
    ...
    if (options && options.AId) {
        if (options.IsTest != undefined && options.IsTest) {
            SocketIp = "http://v3002.bjsxp02.host.35.com/tpl/Wap/default/common/js/112.124.16.233";
...
ChatFloat.prototype = {
    initialize: function (options, weimobid, msgcount, socket) {
        ...
        mydiv.style.background = "url('MobileChatFloat.png'/*tpa=http://kf.weimob.com/images/MobileChatFloat.png*/) no-repeat 0px 0px";
